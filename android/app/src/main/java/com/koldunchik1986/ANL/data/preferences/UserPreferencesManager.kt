package com.koldunchik1986.ANL.data.preferences
...
// Extension для удобной работы с DataStore
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "abclient_settings")

/**
 * Менеджер пользовательских настроек - эквивалент функциональности настроек из Windows клиента
 * Использует DataStore для хранения данных и EncryptedSharedPreferences для защиты конфиденциальной информации
 */
@Singleton
class UserPreferencesManager @Inject constructor(
    ...
    // Encrypted SharedPreferences для хранения конфиденциальной информации
    ...
    suspend fun saveProfile(profile: UserProfile) {
        ...
        // Сохраняем конфиденциальные данные профиля
    ...
    suspend fun deleteProfile(profileId: String) {
        ...
        // Если удаляемый профиль был текущим, сбрасываем его
    ...
    /**
     * Установка текущего никнейма пользователя
     */
    ...
    /**
     * Проверка, первый ли запуск приложения
     */
    ...
    /**
     * Сохранение конфиденциальных данных профиля
     */
    private fun saveEncryptedData(profile: UserProfile) {
        // Сохраняем пароль и Flash пароль для защиты конфиденциальных данных
    ...
    /**
     * Удаление конфиденциальных данных профиля
     */
